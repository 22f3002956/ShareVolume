...
Your assigned company: Apollo Global Management (APO), CIK 0001858681.

Fetch https://data.sec.gov/api/xbrl/companyconcept/CIK0001858681/dei/EntityCommonStockSharesOutstanding.json (set a descriptive User-Agent per SEC guidance).
...
`{"entityName": "Apollo Global Management", "max": {"val": ..., "fy": ...}, "min": {"val": ..., "fy": ...}}`
